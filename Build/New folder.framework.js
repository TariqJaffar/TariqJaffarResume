...
var ASM_CONSTS = {
  1552016: () => { return Module.webglContextAttributes.premultipliedAlpha; },  
 1552077: () => { return Module.webglContextAttributes.preserveDrawingBuffer; },  
 1552141: () => { return Module.webglContextAttributes.powerPreference; },  
 1552199: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 1552254: ($0) => { performance.now = function() { return $0; }; },  
 1552302: ($0) => { performance.now = function() { return $0; }; },  
 1552350: () => { performance.now = Module['emscripten_get_now_backup']; }
};
